...
10. Which of the steps could be omitted?
        none of the steps could be omitted

11. Why might it be a bad idea to omit them?
        both are necessary to commit fruit.txt file;
        git add fruits. txt is to add file to the index
        git commit -m is to commit or update the changes
